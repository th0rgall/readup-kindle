...
import { CancellationToken } from "./AsyncTracker.ts";
import Fetchable from "./Fetchable.ts";
import { isProblemDetails, ProblemDetails } from "./ProblemDetails.ts";
import { FailureResult, ResultType } from "./Result.ts";
...
export function mapPromiseErrorToResultIfNotCancelled(
  reason: any,
  handler: (result: FailureResult<string>) => void,
) {
