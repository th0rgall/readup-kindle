...
export function isAuthServiceCredentialAuthTokenResponse(
  response: AuthServiceCredentialAuthResponse,
): response is AuthServiceCredentialAuthTokenResponse {
  return (
    (response as AuthServiceCredentialAuthTokenResponse).authServiceToken !=
      null
  );
}
